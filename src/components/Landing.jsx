...
function Landing() {
  return (
    <div className="min-h-[calc(100vh-90px)] flex flex-col justify-center items-center lg:items-start pl-4 lg:pl-16" >
      ...
      <button className="mt-8 lg:mt-12 bg-[#f27638] text-white pr-6 pl-6 pt-4 pb-4 rounded-full outline outline-black text-lg lg:text-xl hover:bg-[#fb905b] "><Link to={'/contact'}>Contact Us</Link></button>
    </div>
  )
}
